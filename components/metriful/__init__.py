...
from esphome.const import (
    UNIT_CELSIUS, UNIT_PERCENT, UNIT_OHM, UNIT_PPM, UNIT_LUX, UNIT_PA, UNIT_DBA, 
...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_CO2E, default=SENSOR_SCHEMA.unit_of_measurement(UNIT_PPM).accuracy_decimals(1).device_class(DEVICE_CLASS_AQI)): sensor.sensor_schema(),
        cv.Optional(CONF_BVOC, default=SENSOR_SCHEMA.unit_of_measurement(UNIT_PPM).accuracy_decimals(2).device_class(DEVICE_CLASS_AQI)): sensor.sensor_schema(),
